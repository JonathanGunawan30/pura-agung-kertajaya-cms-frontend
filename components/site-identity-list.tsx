...
export function SiteIdentityList() {
    ...
    const handleDelete = async (id: string) => {
        const result = await showConfirmAlert(
            ...
            "Are you sure you want to delete this site identity?"
        )
        ...
        try {
            ...
            await showSuccessAlert("Success", "Site identity deleted successfully")
        } catch (error) {
            console.error("Failed to delete site identity:", error)
            const msg = error instanceof Error ? error.message : "Failed to delete identity"
                ...
                <Card className="border-border/50">
                    <CardContent className="p-8 text-center">
                        <p className="text-muted-foreground">
                            No site identity configured yet. Create one to get started!
                        </p>
                    </CardContent>
                </Card>
            ) : (

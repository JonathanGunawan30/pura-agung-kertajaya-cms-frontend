...
export function GalleryList() {
    ...
    const handleDelete = async (id: string, images: any) => {
        ...
        try {
            ...
            await showSuccessAlert("Terhapus!", "Item galeri berhasil dihapus.")
        } catch (error) {
            const err = error instanceof Error ? error.message : "Gagal menghapus item"
    ...
    const paginated = filteredItems.slice(startIdx, startIdx + limit)

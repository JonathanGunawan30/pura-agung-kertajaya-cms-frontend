...
export function HeroSlidesList() {
    ...
    const handleDelete = async (id: string, imageUrl: string) => {
        ...
        try {
            ...
            const err = error instanceof Error ? error.message : "Failed to delete slide"
    ...
    const paginated = slides.slice(startIdx, startIdx + limit)
    const totalPages = Math.ceil(slides.length / limit)
